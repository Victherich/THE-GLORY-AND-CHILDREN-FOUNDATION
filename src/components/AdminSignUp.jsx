...
const lightSignupColors = {
  ...
  titleColor: '#3A7DCF',          // A pleasant blue for the title (matches accent from dashboard)
  ...
  buttonBackground: '#4A90E2',    // Accent blue for buttons
  ...
  linkHover: '#4A90E2',           // Accent blue for link text hover
};
